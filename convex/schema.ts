...
export default defineSchema({
  ...
  financialAuditEvents: defineTable({
    ...
    subject: v.string(),
    summary: v.string(),
  }).index('by_subject_and_occurred_at', ['subject', 'occurredAt']),
  materialAlerts: defineTable({
    createdAt: v.number(),
    dedupeKey: v.string(),
    ...
    .index('by_subject_and_dedupe_key', ['subject', 'dedupeKey'])
    .index('by_subject_and_state_and_updated_at', ['subject', 'state', 'updatedAt']),
